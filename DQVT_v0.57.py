...
wb = openpyxl.load_workbook("D:/Doc/IT_audit/감리수행 프로젝트 현황/2020/온라인물류ERP/감리계획서및결과서/결과서/DQVT_양식_올가.xlsx")
...
wb_r.save("C:/Users/Pulmuone/Desktop/DQVT_result_올가.xlsx")
